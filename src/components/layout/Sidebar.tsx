...
import { Users, BookOpen, CheckSquare, LayoutDashboard, LogOut, GraduationCap, Shield, Clock, FileText } from "lucide-react";
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 min-h-screen flex flex-col">
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-100">
        <h2 className="font-bold text-slate-800 text-lg tracking-tight">Sist. Frequência</h2>
      </div>
      ...
      {/* Rodapé da Sidebar (ex: botão de sair) */}
      <div className="p-4 border-t border-slate-100">
        <button 
          ...
          className="flex items-center gap-3 px-3 py-2 w-full rounded-md text-sm font-medium text-slate-600 hover:bg-red-50 hover:text-red-600 transition-colors group"
        >
