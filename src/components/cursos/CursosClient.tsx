      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          {activeTab === "cursos" ? (
            ...
            <button onClick={() => { setEditingTurma({ nome: "", curso_id: "", turno: "Manhã", horario: "08:30 - 10:00", dias_semana: [], vagas: 30 }); setIsTurmaModalOpen(true); }} className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-md text-sm font-medium flex items-center gap-2">
